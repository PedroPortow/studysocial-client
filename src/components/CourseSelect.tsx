...
interface CourseSelectProps extends Omit<SelectProps, "children" | "selectedKeys" | "onSelectionChange"> {
  value?: string;
  onValueChange: (courseName: string) => void;
}

export function CourseSelect({ value, onValueChange, ...props }: CourseSelectProps) {
